...
- (NSArray *)viewControllers {
    ...
    FLClassificationVC *secondViewController = [[FLClassificationVC alloc] init];
    RootNavigationController *secondNavigationController = [[RootNavigationController alloc]
                                                    initWithRootViewController:secondViewController];

   GWCShoppingCartVC *thirdViewController = [[GWCShoppingCartVC alloc] init];
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"home_icon_home_default",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : [UIImage imageNamed:@"home_icon_home_selected"], /* NSString and UIImage are supported*/
...
//                                                 CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(0, 0)]
    ...
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  ...
                                                  CYLTabBarItemImage : @"home_icon_my_default",
                                                  CYLTabBarItemSelectedImage : [UIImage imageNamed:@"home_icon_my_selected"],
                                                  };
...
//    tabBarController.tabBarHeight = kTabBarHeight;
    ...
    selectedAttrs[NSForegroundColorAttributeName] = BarItem_Color;
//
//    selectedAttrs[NSFontAttributeName] = font(10);
...
//    [tabBar setTitleTextAttributes:selectedAttrs forState:UIControlStateNormal];
    
//    [[UITabBarItem tabBar] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor redColor]} forState:UIControlStateNormal];
