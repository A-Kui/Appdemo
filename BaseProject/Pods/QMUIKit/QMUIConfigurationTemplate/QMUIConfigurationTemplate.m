...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarBarTintColor = Main_Color;                                    // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    ...
    QMUICMI.navBarTitleFont = UIFontMake(17);                                   // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    QMUICMI.navBarLargeTitleColor = UIColorWhite;                               // NavBarLargeTitleColor : UINavigationBar 在大标题模式下的标题颜色，仅在 iOS 11 之后才有效
    QMUICMI.navBarLargeTitleFont = UIFontMake(22);                              // NavBarLargeTitleFont : UINavigationBar 在大标题模式下的标题字体，仅在 iOS 11 之后才有效
    ...
    QMUICMI.tabBarBarTintColor = Main_Color;                                    // TabBarBarTintColor : UITabBar 的 barTintColor
    QMUICMI.tabBarShadowImageColor = nil;                                       // TabBarShadowImageColor : UITabBar 的 shadowImage 的颜色，会自动创建一张 1px 高的图片
    QMUICMI.tabBarTintColor = UIColorWhite;                                     // TabBarTintColor : UITabBar 的 tintColor
    QMUICMI.tabBarItemTitleColor = UIColorBlack;                                // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = TabBarTintColor;                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleFont = UIFontMake(12);                               // TabBarItemTitleFont : UITabBarItem 的标题字体
